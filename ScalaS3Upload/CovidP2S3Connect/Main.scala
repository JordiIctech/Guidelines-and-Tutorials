...
object Main {
  ...
  def userMenu(): Unit = {
    ...
    //////////////Edwin
    println("[11] How many people were recovered worldwide by the last quarter of 2020 N/A")
    println("[12] What are the top 10 cities with number of deaths in the US? N/A")
    println("[13] What are the countries with most recovered covid cases during the pandemic? N/A")
    //////Oscar
