...
libraryDependencies ++= Seq("org.apache.hadoop" % "hadoop-aws" % "3.2.1")
libraryDependencies ++= Seq("org.apache.hadoop" % "hadoop-common" % "3.2.1")
libraryDependencies ++= Seq("org.apache.hadoop" % "hadoop-auth" % "3.2.1")